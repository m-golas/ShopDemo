...
@NgModule({
  declarations: [ShopPageComponent, CategoryListComponent, ProductListComponent, ProductCardComponent, CartPageComponent, CartListComponent, CartSummaryComponent, AmountInputComponent, DeleteButtonComponent, ShopLayoutComponent, CartLayoutComponent],
  imports: [
    CommonModule,
    ShopRoutingModule,
    SharedModule,
